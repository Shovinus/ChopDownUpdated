...
public class BiomesOPlenty {
	public static TreeConfiguration[] Trees = new TreeConfiguration[] { 
			...
			new TreeConfiguration().setLogs("biomesoplenty:log_0:5").setLeaves("biomesoplenty:leaves_2:2","biomesoplenty:leaves_2:1","biomesoplenty:leaves_2:9","biomesoplenty:leaves_2:10"),
			new TreeConfiguration().setLogs("biomesoplenty:log_0:6").setLeaves("biomesoplenty:leaves_1:8"),
			...
			new TreeConfiguration(8,12,0,3).setLogs("biomesoplenty:log_1:6").setLeaves("biomesoplenty:leaves_4:0","biomesoplenty:leaves_4:8"),
			new TreeConfiguration().setLogs("biomesoplenty:log_1:7").setLeaves("biomesoplenty:leaves_4:9","biomesoplenty:leaves_4:17"),
			new TreeConfiguration(8,12,0,5).setLogs("biomesoplenty:log_2:4").setLeaves("biomesoplenty:leaves_4:2","biomesoplenty:leaves_4:10"),
			new TreeConfiguration(8,12,4,0).setLogs("biomesoplenty:log_2:5").setLeaves("biomesoplenty:leaves_4:3","biomesoplenty:leaves_4:11"),
			...
			new TreeConfiguration().setLogs("biomesoplenty:log_3:7").setLeaves("biomesoplenty:leaves_3:8"),
