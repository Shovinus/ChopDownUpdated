...
public class Config {
	...
	public static String[] DefaultTreeConfigs () {
		return new String[] {
				...
				"{\"blocks\":[\"minecraft:log:0\",\"minecraft:leaves:0\",\"biomesoplenty:leaves_0:1\",\"biomesoplenty:leaves_3:9\",\"biomesoplenty:leaves_3:5\",\"biomesoplenty:leaves_2:3\",\"biomesoplenty:leaves_1:5\"]}",
				"{\"blocks\":[\"minecraft:log:1\",\"minecraft:leaves:1\"]}",
				"{\"blocks\":[\"minecraft:log:2\",\"minecraft:leaves:2\",\"biomesoplenty:leaves_0:0\"]}",
				"{\"blocks\":[\"minecraft:log:3\",\"minecraft:leaves:3\"]}",
				"{\"blocks\":[\"minecraft:log2:0\",\"minecraft:leaves2:0\",\"biomesoplenty:leaves_0:1\"]}",
				"{\"blocks\":[\"minecraft:log2:1\",\"minecraft:leaves2:1\",\"biomesoplenty:leaves_0:1\",\"biomesoplenty:leaves_1:5\"]}",
