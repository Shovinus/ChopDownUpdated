...
public class Plants {
	public static TreeConfiguration[] Trees = new TreeConfiguration[] {
			new TreeConfiguration().setLogs("plants2:crystal_log:0").setLeaves("plants2:crystal_leaves:0"),
			new TreeConfiguration().setLogs("plants2:crystal_log:1").setLeaves("plants2:crystal_leaves:1"),
			new TreeConfiguration().setLogs("plants2:log_0:0").setLeaves("plants2:leaves_0:0"),
